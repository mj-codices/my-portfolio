...
export default function AboutMe({ headingY, p1Y, p2Y, p2Ref, circleY1, circleY2}: AboutMeProps){
    return (
          ...
          <div className="ml-15 relative z-10 pt-10">
            ...
            >
              ...
              <h2 className="mb-10 text-3xl uppercase font-bold tracking-wider opacity-80 text-[#ffff]">
               <span className="text-[#a3a2a2] opacity-100">my</span>{" "}
               story
              </h2>
            </motion.div>
            <motion.div style={{ y: p1Y }}>
              <p className="text-lg w-110 leading-9 ml-7 mb-3">
                I’m a full-stack software developer based in Southern
                California. My passion for programming stems from a love of
                polished, intuitive user experiences, and this is why I thrive
            ...
            <motion.div ref={p2Ref} style={{ y: p2Y }}>
              <p className="text-lg w-150 leading-9 ml-7">
                ...
                Pacific Coast with my wife in our old VW wagon.
              </p>
            </motion.div>
          </div>
        </FadeSection>
            ...
            <FadeSection>
              <div className="relative flex -translate-x-15">
                <h2 className="pt-8 ml-4 mr-3 uppercase text-3xl font-bold tracking-wider">
                  <span className="text-[#858383]">my</span>{" "}
                  process
                </h2>
              ...
              <div>
                ...
                <div className="translate-x-30 -translate-y-14 mt-3">
                  ...
                  <p className="w-30 pt-1 panel-para leading-4 text-end translate-x-20">
                    Writing clean, scalable code and architectural
                    implementation.
                  </p>
                </div>
                <div className="translate-x-31 -translate-y-18 mt-3">
                  ...
                  <p className="w-50 pt-1 panel-para leading-4">
                    Cloud delivery, server monitoring, and continuous
                    maintenance.
                  </p>
                </div>
              </div>
